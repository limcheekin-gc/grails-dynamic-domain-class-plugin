...
public class DefaultGrailsDomainConfiguration extends Configuration implements GrailsDomainConfiguration {
    ...
    public void setGrailsApplication(GrailsApplication application) {
		    println "MyConfigClass: setGrailsApplication = $application"
    ...
    protected void secondPassCompile() throws MappingException {
		println "${this.class.name} secondPassCompile"
        if (configLocked) {
            return;
        }
	...
	// http://jira.codehaus.org/browse/GRAILS-6807
  @Override
  public SessionFactory buildSessionFactory() throws HibernateException {
     // work around HHH-2624
     addFilterDefinition(new FilterDefinition(    
        "dynamicFilterEnabler","1=1", Collections.emptyMap()
     ));
